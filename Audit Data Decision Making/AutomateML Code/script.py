# This file has been autogenerated by version 1.53.2 of the Azure Automated Machine Learning SDK.
...
automl_run_id = 'gray_leg_mtxxktyl43_0'
...
def generate_data_transformation_config():
    ...
    column_group_1 = ['District_Loss', 'History']
    
    column_group_0 = [['Sector_score'], ['LOCATION_ID'], ['PARA_A'], ['Score_A'], ['Risk_A'], ['PARA_B'], ['Score_B'], ['Risk_B'], ['TOTAL'], ['numbers'], ['Score_B_1'], ['Risk_C'], ['Money_Value'], ['Score_MV'], ['Risk_D'], ['PROB'], ['RiSk_E'], ['Prob'], ['Risk_F'], ['Score'], ['Inherent_Risk'], ['CONTROL_RISK'], ['Audit_Risk']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/canadacentral/workspaces/8c0578a6-07a7-44bb-8a01-47e619e38e28/data/main/versions/1',     help='Default training dataset uri is populated from the parent run')
